  ...
  <layout-one :title="'Unrecorded Call'">
          ...
          <v-card-text>
            <v-container grid-list-md>
              <form>
                ...
                <v-layout v-if=" selectUnRecordedIR.value== 7">
                  <v-flex lg12>
                    <v-text-field v-model="editedItem.ReferredTo" label="Referred To"></v-text-field>
                  </v-flex>
                </v-layout>
    ...
    >
      <template slot="items" slot-scope="props">
        ...
        <td class="text-xs-left">{{ props.item.ReferredTo }}</td>
    ...
    postUnRecordedIR() {
      ...
      if (this.selectUnRecordedIR.value == 7) {
        if (
          ...
          this.editedItem.ReferredTo == null ||
          this.editedItem.ReferredTo.length == 0
        ) {
          alert("please enter referred to");
          isTrue = false;
          return;
        }
      }
