  ...
  <v-layout row wrap class="pa-2">
    <v-flex lg12 class="mt-12">
      <v-card class="black--text elevation-5">
        <v-layout>
          <v-flex lg12>
            <v-card-title class="headline grey lighten-3 pa-1 ma-0" primary-title>Category Customer</v-card-title>
            <v-card-title>
                    ...
                    <v-container grid-list-md>
                      <v-card class="elevation-10">
                        <v-card-title
                          ...
                          primary-title
                        >Category Customer</v-card-title>
                        <v-divider></v-divider>
                        <!-- <v-flex lg6>
                          <v-text-field
  ...
  methods: {
    ...
    async tableLoad() {
      ...
      const res = await axios
        .get(this.$urlApplication + "CategoryCustomer/GetCategoryCustomers")
        .then(res => {
    ...
    post() {
      ...
      axios({
        method: "post",
        url: this.$urlApplication + "CategoryCustomer/Post",
        data: obj
      })
        .then(res => {
    ...
    delete(id) {
      ...
      axios({
        method: "delete",
        url:
          this.$urlApplication + "CategoryCustomer/Delete?companyId=1&id=" + pId
      })
        .then(res => {
          this.IsSnackBar = false;
          this.tableLoad();
    ...
    dialogOpen() {
      if (this.editedItem.CategoryCustomerId == undefined) {
        ...
        //Edite Record
        //this.changeCategoryCustomers(this.selectCategoryCustomers);
      }
    },
    close() {
      if (!this.dialog) {
