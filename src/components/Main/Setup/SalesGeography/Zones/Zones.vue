  ...
  <v-layout row wrap class="pa-2">
    <v-flex lg12 class="mt-12">
      <v-card class="black--text elevation-5">
        <v-layout>
          <v-flex lg12>
            <v-card-title class="headline grey lighten-3 pa-1 ma-0" primary-title>Zone</v-card-title>
            <v-card-title>
                    ...
                    <tr v-for="row in rows">
                      ...
                      <td class="justify-center layout px-0">
                        <v-btn
                          ...
                          :to="urlRoute+'Edit?id=' +row.SaleGeographyZoneId"
                        >
...
export default {
  ...
  data() {
    return {
      ...
      isLoading: true,
      IsSnackBar: false,
      componentName: "SaleGeographyZone",
      urlRoute: "/Zones"
    };
  }
};
