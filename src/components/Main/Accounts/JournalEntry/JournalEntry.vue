  ...
  <v-layout row wrap class="pa-2">
    <v-flex lg12 class="mt-12">
      <v-card class="black--text elevation-5">
        <v-layout>
          <v-flex lg12>
            <v-card-title class="headline grey lighten-3 pa-1 ma-0" primary-title> Journal Entry</v-card-title>
            <v-card-title>
                ...
                <table class="csmTable">
                  <thead>
                    <tr>
                      ...
                      <th v-on:click="sortTable('Memo',$event)">
                        Memo
                        <v-icon style="font-size:15px">keyboard_arrow_up</v-icon>
                      </th>
                      ...
                      <th v-on:click="sortTable('Amount',$event)">
                        Amount
                        <v-icon style="font-size:15px">keyboard_arrow_up</v-icon>
                      </th>
                  ...
                  <tbody>
                    <tr v-for="row in rows">
                      ...
                      <td class="text-xs-left">{{row.Memo}}</td>
                      <td class="text-xs-left">{{row.BranchName}}</td>
                      <td class="text-xs-right">{{row.Amount}}</td>
                      ...
                      <td class="justify-center layout px-0">
                        <v-btn
                          ...
                          :to="urlRoute+'Edit?id=' +row.AccountJournalEntryId"
                        >
