    ...
    <v-card-text>
      ...
      >
        <template slot="items" slot-scope="props">
          ...
          <td class="text-xs-left">{{ parseInt(props.item.MAK) }}</td>
          <td class="text-xs-left">{{ parseInt(props.item.Wasif) }}</td>
          <td class="text-xs-left">{{ parseInt(props.item.Ahsin) }}</td>
          <td class="text-xs-left">{{ parseInt(props.item.Shahrukh) }}</td>
        </template>
        <v-alert
          slot="no-results"
          :value="true"
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "MAK", value: "MAK" },
        { text: "Wasif", value: "Wasif" },
        { text: "Ahsin", value: "Ahsin" },
        { text: "Shahrukh", value: "Shahrukh" },
      ],
