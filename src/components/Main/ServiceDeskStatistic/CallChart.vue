  ...
  methods: {
    makeDataStructure() {
      ...
      for (var i = 0; i < objData.length; i++) {
        ...
        var mak = objData[i].MAK;
        var wasif = objData[i].Wasif;
        var ahsin = objData[i].Ahsin;
        var shahrukh = objData[i].Shahrukh;
        ...
        this.arrayMAK.push(mak);
        this.arrayWasif.push(wasif);
        this.arrayAhsin.push(ahsin);
        this.arrayShahrukh.push(shahrukh);
