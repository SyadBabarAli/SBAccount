                ...
                <v-flex lg12>
                  ...
                  >
                    <template slot="items" slot-scope="props">
                      ...
                      <td class="text-xs-left">{{ props.item.ClassificationCategory }}</td>
  ...
  methods: {
    ...
    fetchResolvedTicketWithFeedback() {
      ...
      if (difference < 0) {
        ...
        //   .get(
        //     this.$urlApplication +
        //       "AllTicket/GetAllTicket?isCreated=" +
        //       this.selectIsCreated.value +
        //       "&start_date=" +
        //       `${this.$store.getters.startDate}T00:00:00` +
        //       "&end_date=" +
        //       `${this.$store.getters.endDate}T23:59:59` +
        //       "&userCreated=" +
        //       CreatedBy +
        //       "&userResolved=" +
        //       ResolvedBy +
